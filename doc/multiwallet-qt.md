...
In order to support loading of multiple wallets in traficoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is traficoin.cpp.
...
Changes to traficoin.cpp
----------------------
traficoin.cpp is the entry point into traficoin-qt, and as such, will require some minor modifications to provide hooks for
