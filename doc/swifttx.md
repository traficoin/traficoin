...
This mechanism has been integrated into Bitcore-Node-TRAFICOIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TRAFICOIN-Project/insight-api-traficoin#web-socket-api](https://github.com/TRAFICOIN-Project/insight-api-traficoin#web-socket-api) 
* API: [https://github.com/TRAFICOIN-Project/insight-api-traficoin#swifttx-transactions](https://github.com/TRAFICOIN-Project/insight-api-traficoin#swifttx-transactions) 
...
By default, the TRAFICOIN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TRAFICOIN Core daemon:
