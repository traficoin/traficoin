...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/traficoin-cli.cpp \
           src/traficoin-tx.cpp \
           src/traficoin.cpp \
           src/db.cpp \
           ...
           src/qt/traficoin.cpp \
           src/qt/traficoinstrings.cpp \
...
RESOURCES += src/qt/traficoin.qrc src/qt/traficoin_locale.qrc

TRANSLATIONS += src/qt/locale/traficoin_bg.ts \
                src/qt/locale/traficoin_de.ts \
                src/qt/locale/traficoin_en.ts \
                src/qt/locale/traficoin_es.ts \
                src/qt/locale/traficoin_fi.ts \
                src/qt/locale/traficoin_fr.ts \
                src/qt/locale/traficoin_it.ts \
                src/qt/locale/traficoin_ja.ts \
                src/qt/locale/traficoin_pl.ts \
                src/qt/locale/traficoin_pt.ts \
                src/qt/locale/traficoin_ru.ts \
                src/qt/locale/traficoin_sk.ts \
                src/qt/locale/traficoin_sv.ts \
                src/qt/locale/traficoin_vi.ts \
                src/qt/locale/traficoin_zh_CN.ts \
                src/qt/locale/traficoin_zh_TW.ts
