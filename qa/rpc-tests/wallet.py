...
#   c) node1 mines 32 blocks, so now node 0 has 60001trfc, node 1 has 4250trfc, node2 has none.
#   d) node0 sends 601 trfc to node2, in two transactions (301 trfc, then 300 trfc).
