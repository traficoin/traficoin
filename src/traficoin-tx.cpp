...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Traficoin Core traficoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  traficoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded traficoin transaction") + "\n" +
                               "  traficoin-tx [options] -create [commands]   " + _("Create hex-encoded traficoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded traficoin transaction
