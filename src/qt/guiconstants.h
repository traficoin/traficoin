...
/* Traficoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "TRAFICOIN"
#define QAPP_ORG_DOMAIN "traficoin.org"
#define QAPP_APP_NAME_DEFAULT "TRAFICOIN-Qt"
#define QAPP_APP_NAME_TESTNET "TRAFICOIN-Qt-testnet"
