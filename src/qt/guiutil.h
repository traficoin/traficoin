...
/** Utility functions used by the TRAFICOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render TRAFICOIN addresses in monospace font
...
// Parse "traficoin:" URI into recipient object, return true on successful parsing
