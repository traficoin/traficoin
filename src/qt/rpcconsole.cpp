                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzTRFCPathCustom = GetArg("-ztrfcbackuppath", "");
    ...
    if(!strzTRFCPathCustom.empty()) {
        ui->wallet_customztrfcbackuppath->setText(QString::fromStdString(strzTRFCPathCustom));
        ui->wallet_customztrfcbackuppath_label->setVisible(true);
        ui->wallet_customztrfcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzTRFCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the TRAFICOIN RPC console.") + "<br>" +
