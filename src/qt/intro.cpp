...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("TRAFICOIN Core"),
     ...
     * override -datadir in the traficoin.conf file in the default data directory
     * (to be consistent with traficoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
