...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop TRAFICOIN server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "TRAFICOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TRAFICOIN features */
        {"traficoin", "masternode", &masternode, true, true, false},
        {"traficoin", "listmasternodes", &listmasternodes, true, true, false},
        {"traficoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"traficoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"traficoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"traficoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"traficoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"traficoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"traficoin", "masternodedebug", &masternodedebug, true, true, false},
        {"traficoin", "startmasternode", &startmasternode, true, true, false},
        {"traficoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"traficoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"traficoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"traficoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"traficoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"traficoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"traficoin", "mnbudget", &mnbudget, true, true, false},
        {"traficoin", "preparebudget", &preparebudget, true, true, false},
        {"traficoin", "submitbudget", &submitbudget, true, true, false},
        {"traficoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"traficoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"traficoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"traficoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"traficoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"traficoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"traficoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"traficoin", "checkbudgets", &checkbudgets, true, true, false},
        {"traficoin", "mnsync", &mnsync, true, true, false},
        {"traficoin", "spork", &spork, true, true, false},
        {"traficoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getztrfcseed", &getztrfcseed, false, false, true},
        {"zerocoin", "setztrfcseed", &setztrfcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdztrfc", &searchdztrfc, false, false, true},
        {"zerocoin", "dztrfcstate", &dztrfcstate, false, false, true}
...
{
    return "> traficoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:50846/\n";
}
