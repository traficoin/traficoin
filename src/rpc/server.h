...
/**
 * TRAFICOIN RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setztrfcseed(const UniValue& params, bool fHelp);
extern UniValue getztrfcseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdztrfc(const UniValue& params, bool fHelp);
extern UniValue dztrfcstate(const UniValue& params, bool fHelp);
