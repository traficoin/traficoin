Contributing to TRAFICOIN Core
============================

The TRAFICOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TRAFICOIN Core project, and is not to be
confused with overall TRAFICOIN Network Protocol consensus changes.

Whether a pull request is merged into TRAFICOIN Core rests with the project merge
...
Patches that change TRAFICOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the TRAFICOIN consensus, it must have been
...
The project leader is the release manager for each TRAFICOIN Core release.
